...
const AppearancePanel: React.FC = () => {
    ...
    // FIX: Cast string literal keys to TranslationKey to resolve type mismatches with restricted i18n snippet.
    const themes: { id: Theme; label: TranslationKey; }[] = [
        { id: 'light', label: 'appearance.light' as TranslationKey },
        { id: 'dark', label: 'appearance.dark' as TranslationKey },
        { id: 'midnight', label: 'appearance.midnight' as TranslationKey },
        { id: 'dusk', label: 'appearance.dusk' as TranslationKey },
        { id: 'solarized', label: 'appearance.solarized' as TranslationKey },
    ];
